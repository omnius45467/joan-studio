...
function blackcolors_customize($wp_customize) {
    ...
    // Search form in fixed bar
    $wp_customize->add_setting( 'blackcolors_bar_search', array(
        'type'           => 'theme_mod',
        'capability'     => 'edit_theme_options',
        'sanitize_callback' => 'blackcolors_sanitize_checkbox'
    ) );

    $wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'blackcolors_bar_search', array(
        'settings' => 'blackcolors_bar_search',
        'label'    => __( 'Hide search form in fixed bar?', 'blackcolors' ),
        'section'  => 'blackcolors_layout',
        'type'     => 'checkbox',
        'priority' => 4,
    ) ) );
